...
describe('the Parking Service', () => {
      ...
      providers: [
        ParkingService,
        {
          ...
          useValue: jasmine.createSpyObj('ParkingApiService', [
            'getSelectedParkingEntries',
            'getSelectedParkingAreas',
            'getAreaParkingSlots',
          ]),
        },
      ],
  ...
  describe('the *getSelectedParkingLevels* method', () => {
    it('should call getSelectedParkingEntries method from parkingApiService', () => {
      parkingApiService.getSelectedParkingEntries.and.returnValue(
        of({ entries: [{ id: 1 }] })
      );
      parkingApiService.getSelectedParkingAreas.and.returnValue(
        of({ areas: [{ id: 1 }] })
      );
      parkingApiService.getAreaParkingSlots.and.returnValue(
        of({ spots: [{ id: 1 }] })
      );
