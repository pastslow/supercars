...
describe('The Spinner Service', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        { provide: SpinnerService, useValue: jasmine.createSpyObj('SpinnerService', ['getSpinnerDisplayValue$', 'makeSpinnerVisible', 'hideSpinner']) }
      ]
    })
  ...
  describe('the *getSpinnerDisplayValue$* method', () => {
    it('should return a boolean which represents if the spinner is displayed or not', () => {
      ...
      spinnerService.getSpinnerDisplayValue$().subscribe((isSpinnerDisplayed) => {
